...
namespace MultiChatServer
{
    public partial class ChatForm : Form
    {
        ...
        void AppendListText(Control ctrl, string s)
        {
            if (listView1.InvokeRequired) listView1.Invoke(_textAppender, listView1, s);
            else
            {
                string source = listView1.Text;
                listView1.Text = source + Environment.NewLine + s;
            }
        }
